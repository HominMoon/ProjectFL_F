...
public:
	...
	//TSubclassOf<UClimbingComponent> ClimbingComp;
	...
	//custom essential information getter
	UFUNCTION(BlueprintGetter, Category = "ALS|Essential Information")
	bool GetCanMoveLeft() const { return bCanMoveLeft; }

	UFUNCTION(BlueprintGetter, Category = "ALS|Essential Information")
	bool GetCanMoveRight() const { return bCanMoveRight; }
...
protected:
	...
	//change for default rotationmd settings, forward -> velocity
	...
	float RagdollOnLandVelocity = 1500.0f; //change value default:1000 -> 1500
	...
	/*my custom for ragdoll timer*/
	UPROPERTY(BlueprintReadOnly, Category = "ALS|Ragdoll System")
	float LandedVelocity = 0.f;
