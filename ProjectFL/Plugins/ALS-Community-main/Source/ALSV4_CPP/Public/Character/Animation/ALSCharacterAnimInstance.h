...
class ALSV4_CPP_API UALSCharacterAnimInstance : public UAnimInstance, public IClimbInterface
{
	GENERATED_BODY()
...
public:
	...
	class AALSCharacter* Player;

	UPROPERTY(BlueprintReadWrite, Category = "Climb System")
